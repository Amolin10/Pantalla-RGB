...
class Opciones:
    ...
    def abrir_archivo(self): 
        ...
        if os.path.exists(f'{ruta_configuracion}/configuracion.txt') or ruta_configuracion != '':
...
class Resumen:
    ...
    def cargar(self):
        ...
        botonSave = Button(self.root, image=imgSave, text="Envíar configuración   ", compound="right", font=("Verdana", 12), activebackground="#999999", command=self.guardar_configuracion)
...
class ConfiguracionResumen:
    ...
    def cargar(self):
        ...
        imgImagen = Image.open("./iconos/cargar-image.png")
        imgImagen = imgImagen.resize((30, 30))
        imgImagen = ImageTk.PhotoImage(imgImagen)
